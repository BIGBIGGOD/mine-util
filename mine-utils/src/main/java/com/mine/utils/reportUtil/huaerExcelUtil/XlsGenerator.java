package com.mine.utils.reportUtil.huaerExcelUtil;
...
public class XlsGenerator {
     ...
     * 创建excel工具类
     *
     * @param instanseClass        {@link org.apache.poi.xssf.usermodel.XSSFWorkbook}创建的是xlsx <br>
     *                             {@link org.apache.poi.xssf.streaming.SXSSFWorkbook}创建的是xlsx(数据量较大时选用会避免内存溢出)<br>
     *                             {@link org.apache.poi.hssf.usermodel.HSSFWorkbook}创建xls
     * @param rowAccessWindowsSize 当instanseClass={@link org.apache.poi.xssf.streaming.SXSSFWorkbook}时有用,值越小所占用的内存越小 建议5000-10000
     * @param outputStream
     */
