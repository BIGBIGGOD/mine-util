...
/**
 * Twitter的Snowflake算法简单实现
 * Snowflake算法=首位1位+41位毫秒级时间+5位datacenter标志位+5位机器ID+12位当前毫秒内的当前毫秒内的计数，总共64位
 * Created by jiangqd on 2019/3/26.
 */
public class SnowflakeUtil {

    public static void main(String[] args) {
        SnowflakeUtil snowflakeUtil = new SnowflakeUtil(11,22);
        long i = snowflakeUtil.nextId();
        System.out.println(i);
        System.out.println("262546413246177280".length());
    }
